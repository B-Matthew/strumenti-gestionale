				...
				<div class="flex justify-between h-16">
					...
					<div class="flex items-center">
						<div class="ml-3 relative group" ref="dropdown">
							<div class="flex items-center">
								<button type="button" @click="isDropdownOpen.openModal"
								...
								<div @click="isDropdownOpen.openModal" class="ml-2 hidden md:block cursor-pointer">
							...
							<div v-if="isDropdownOpen.isOpen.value"
								class="fixed inset-0 z-50 flex items-center justify-center bg-primary/50 backdrop-blur-2xl px-4">
								<div class="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full text-center">
									...
									<div class="flex justify-center gap-4">
										...
										<button @click="isDropdownOpen.closeModal" class="btn_base">
											Annulla
										</button>
									</div>
								</div>
