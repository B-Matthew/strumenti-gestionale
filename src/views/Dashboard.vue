      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
          ...
          <div class="flex items-center">
            <button class="p-2 rounded-full text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="ml-3 relative group">
              ...
              <!-- Dropdown menu (not shown in this demo) -->
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="rounded-2xl shadow-md bg-gradient-to-r from-blue-500 to-indigo-600 overflow-hidden">
          <div class="px-6 py-8 md:px-10 md:py-10 text-white">
            ...
            <p class="mt-2 max-w-2xl text-blue-100">
              Accesso effettuato con successo. Gestisci facilmente i tuoi strumenti e risorse con il nostro sistema.
            </p>
            <div class="mt-6">
              <button class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-indigo-700 bg-white hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white focus:ring-offset-indigo-700">
                Inizia subito
              </button>
            </div>
          </div>
          ...
          <div class="lg:col-span-2">
            <div class="bg-white shadow rounded-lg">
                    ...
                    <div class="flex space-x-3">
                      ...
                      <div class="min-w-0 flex-1">
                        ...
                        <p class="text-sm text-gray-500">
                          Ha preso in prestito <span class="font-medium">Trapano a percussione</span>
                        </p>
                  ...
                  <li class="py-4">
                    <div class="flex space-x-3">
                      ...
                      <div class="min-w-0 flex-1">
                        ...
                        <p class="text-sm text-gray-500">
                          Ha aggiunto <span class="font-medium">3 nuovi strumenti</span> all'inventario
                        </p>
              ...
              <div class="px-4 py-4 border-t border-gray-200 sm:px-6">
                <a href="#" class="text-sm font-medium text-blue-600 hover:text-blue-500">Visualizza tutte le attività</a>
              </div>
            </div>
          </div>
            ...
            <div class="bg-white shadow rounded-lg">
              ...
              <div class="p-4">
                <div class="grid grid-cols-2 gap-4">
                  <button class="flex flex-col items-center justify-center p-4 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-300 transition-colors">
                    <div class="h-8 w-8 bg-blue-100 text-blue-600 rounded-md flex items-center justify-center mb-2">
                  ...
                  <button class="flex flex-col items-center justify-center p-4 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-300 transition-colors">
                    <div class="h-8 w-8 bg-green-100 text-green-600 rounded-md flex items-center justify-center mb-2">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <button class="flex flex-col items-center justify-center p-4 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-300 transition-colors">
                    <div class="h-8 w-8 bg-indigo-100 text-indigo-600 rounded-md flex items-center justify-center mb-2">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <button class="flex flex-col items-center justify-center p-4 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-300 transition-colors">
                    <div class="h-8 w-8 bg-yellow-100 text-yellow-600 rounded-md flex items-center justify-center mb-2">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
